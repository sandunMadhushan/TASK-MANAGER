...
| 3 | [`03-backend-aws.md`](./03-backend-aws.md) | Express API on AWS Free Tier (EC2) |
...
| 10 | [`10-desktop-release-github-updater.md`](./10-desktop-release-github-updater.md) | Tauri desktop release + GitHub updater flow |
